...
func init() {
	...
	debugLogger, _ = New(FileConf("./rp/lg/logs/debug.log"))
	infoLogger, _ = New(FileConf("./rp/lg/logs/info.log"))
	warnLogger, _ = New(FileConf("./rp/lg/logs/warn.log"))
	errorLogger, _ = New(FileConf("./rp/lg/logs/error.log"))
}
